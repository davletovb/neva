...
- Aggregate-contention, same-account sharing, conflicting-scope configuration, cancellation cleanup, spend reservations, authoritative reconciliation, and real spawned-process SQLite concurrency are covered by tests.
